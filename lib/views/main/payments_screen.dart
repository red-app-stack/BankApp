                ...
                Card(
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        _buildServiceItem(
                            svgPath: homeIconPaths[0],
                            label: 'Карты',
                            theme: theme),
                        _buildServiceItem(
                            svgPath: homeIconPaths[1],
                            label: 'Депозиты',
                            theme: theme),
                        _buildServiceItem(
                            svgPath: homeIconPaths[2],
                            label: 'Кредиты',
                            theme: theme),
                        _buildServiceItem(
                            svgPath: homeIconPaths[3],
                            label: 'Рассрочка',
                            theme: theme),
                      ],
                    ),
                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            _buildServiceItem(
                                svgPath: popularIconPaths[0],
                                label: 'Связь',
                                theme: theme),
                            _buildServiceItem(
                                svgPath: popularIconPaths[1],
                                label: 'Интернет',
                                theme: theme),
                            _buildServiceItem(
                                svgPath: popularIconPaths[2],
                                label: 'Транспорт',
                                theme: theme),
                            _buildServiceItem(
                                svgPath: popularIconPaths[3],
                                label: 'Ком. услуги',
                                theme: theme),
                          ],
                        ),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildFavoriteItem(
                          svgPath: 'assets/icons/utilities.svg',
